<div class="relative cart-widget">
    <a href="{{ route('carts.index') }}" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition">
        <div class="relative">
        ...
        @if (Auth::check())
            <div class="hidden md:flex flex-col items-start">
                ...
                <span data-cart-badge class="font-semibold text-gray-900">0</span>
            </div>
        @endif
    </a>

    {{-- Mini Cart Dropdown --}}
    <div class="cart-dropdown hidden absolute right-0 mt-3 w-80 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
        <div class="p-4">
            <h3 class="font-semibold mb-4 text-gray-900">Shopping Cart</h3>
