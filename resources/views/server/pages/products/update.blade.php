...
@section('content')
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h3 class="card-title mb-0">
                            <i class="fa fa-edit"></i> Cập nhật sản phẩm: {{ $products->tensp }}
                        </h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('products.update', $products->id) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="sku" value="{{ old('sku', $products->sku ?? '') }}"
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0"><i class="fa fa-folder"></i> Danh Mục & Thương Hiệu</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @error('category_id')
                                                    <span
                                                        class="invalid-feedback text-danger d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="thuonghieu_id">Thương Hiệu <span
                                                        class="text-danger">*</span></label>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Album ảnh chung cho sản phẩm -->
                                    <div class="form-group">
                                        <label class="font-weight-bold">
                                            Album Ảnh Sản Phẩm
                                            <small class="text-muted">(Áp dụng cho tất cả các biến thể)</small>
                                        </label>
                                        <div class="album-upload-wrapper">
                                            ...
                                            <div id="sortable" class="row upload-list">
                                                @php
                                                    ...
                                                    // Hoặc lấy từ product variants
                                                    elseif (
                                                        isset($products) &&
                                                        $products->sanpham_variants->count() > 0
                                                    ) {
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0"><i class="fa fa-align-left"></i> Mô Tả Sản Phẩm</h5>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea class="form-control ck-editor" id="mota" name="mota" data-height="400">{{ old('mota', $products->mota ?? '') }}</textarea>
                                        @error('mota')
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0">
                                        ...
                                        <a href="{{ route('products.index') }}"
                                            class="btn btn-secondary btn-lg confirm-cancel">
    ...
    <script>
        ...
        // Kiểm tra album trống
        function checkEmptyAlbum() {
            const uploadList = document.getElementById('sortable');
            const albumItems = uploadList.querySelectorAll('.album-item');
            ...
            if (albumItems.length === 0) {
                uploadList.innerHTML = `
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            <i class="fa fa-info-circle"></i> 
                            Chưa có ảnh trong album. Click nút "Thêm Ảnh Vào Album" để thêm ảnh.
                        </div>
                    </div>
                `;
            }
        ...
        if (typeof $.fn.sortable !== 'undefined') {
            $("#sortable").sortable({
                ...
                items: '.col-xl-2, .col-md-3, .col-sm-4, .col-6'
            });
        }
        // Confirm trước khi hủy form
        document.querySelector('.confirm-cancel')?.addEventListener('click', function(e) {
